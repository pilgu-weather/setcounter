(function () {
  ...
  const EN = {
    ...
    "이번 달 요약": "Monthly summary", "근육 사용 분포": "Muscle distribution", "상세 기록": "Workout details", "SOS 사유": "SOS note",
  ...
  const PATTERNS = [
    ...
    [/^(.+) 기록을 삭제하면 세트와 통계에서도 사라집니다\.$/, "Deleting $1 will also remove its sets and statistics."],
