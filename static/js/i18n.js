(function () {
  ...
  const EN = {
    ...
    "이번 달 요약": "Monthly summary", "근육 사용 분포": "Muscle distribution", "완료 세트 기준": "Based on completed sets", "상세 기록": "Workout details", "세트 상세": "Set details", "SOS 사유": "SOS note", "보기": "View", "보기 ›": "View ›", "최고": "Best", "총": "Total",
    ...
    "월요일부터 일요일 사이 원하는 3일에 운동하면 됩니다. 나머지 4일은 쉬어도 경험치가 차감되지 않습니다. 설정한 주는 안내 기간이며 다음 완료 주부터 판정합니다.": "Complete your target on any three days from Monday through Sunday. Rest days do not reduce XP. The week you change this setting is a grace period; evaluation starts with the next full week.",
    "쉬는 날도 계획의 일부": "Rest is part of the plan", "쉬어야 하는 이유를 기록해두세요. SOS를 저장하면 해당 날짜는 주간 운동 목표에서 운동한 날로 반영됩니다.": "Note why you need a rest day. Saving an SOS counts that date toward your weekly workout goal.",
    ...
    "계정과 기록을 삭제할까요?": "Delete your account and records?", "운동·세트 기록, SOS, 레벨, 게시글, 댓글, 좋아요와 푸시 구독이 모두 삭제되며 복구할 수 없습니다.": "Workouts, sets, SOS entries, levels, posts, comments, likes, and push subscriptions will be permanently deleted.",
    ...
    "SOS 사유를 입력해주세요.": "Enter an SOS reason.", "목표 세트를 이미 채웠습니다.": "You have already completed the target sets.",
    ...
    "레벨업": "Level up", "레벨다운": "Level down", "경험치 차감": "XP deduction", "레벨 하락": "Level decreased", "레벨 유지": "Level maintained",
    ...
    "SOS 기록은 무엇인가요?": "What is an SOS entry?", "아프거나 바빠 운동하지 못한 날을 면제 처리하는 기능입니다. 달력에서 날짜를 고른 뒤 메뉴의 SOS 기록에 사유를 남기세요.": "SOS lets you record a day you could not train because you were ill or busy. Choose a date in Calendar, then add a reason from the SOS section in Menu.",
    ...
    "시행일: 2026년 8월 8일": "Effective: August 8, 2026", "수집하는 정보": "Information we collect", "이용 목적": "How we use information", "동의 거부": "Declining consent", "보관 및 보호": "Retention and protection", "외부 전송": "External processing", "쿠키와 기기 저장소": "Cookies and device storage", "문의": "Contact",
    ...
    "사용자 식별 키, 닉네임, 묶음 운동 시작 중량 설정을 위한 성별, 계정 이메일과 비밀번호 해시, 운동 날짜·종목·세트·무게·횟수·휴식시간, SOS 사유, 주간 운동 목표, 레벨·경험치 이력과 통계, 게시글·댓글·좋아요·신고·차단 관계, 운영 조치 내역, 보안용 해시 식별값 및 알림 구독 정보를 처리합니다.": "We process your user key, nickname, gender used to set workout-plan starting weights, account email and password hash, workout dates, exercises, sets, weights, reps and rest times, SOS reasons, weekly goals, level and XP history and statistics, posts, comments, likes, reports, blocked-user relationships, moderation actions, security hashes, and notification subscriptions.",
    ...
    "서비스 이용 시: 운동 날짜, 종목, 세트, 무게, 횟수, 세트 간 휴식시간, SOS 사유, 주간 운동 목표, 레벨·경험치 변동 이력과 통계": "Service use: workout dates, exercises, sets, weights, reps, rest times, SOS reasons, weekly goals, level and XP history, and statistics",
    ...
    "처리 항목, 목적 또는 외부 처리 방식이 중요한 수준으로 변경되면 시행 전에 앱 또는 공개 정책 페이지를 통해 알립니다. 이전 시행본과 동의 이력은 서비스의 정책 버전 기록으로 관리합니다.": "We will provide notice in the app or on the public policy page before material changes to processed information, purposes, or external processing take effect. Prior versions and consent history are retained in the Service's policy-version records.",
    ...
    "Set Counter는 운동 세트 기록, 통계, 달력, SOS 사유 기록 및 운동 커뮤니티 기능을 제공하는 개인 운동 기록 서비스입니다.": "Set Counter is a personal workout log that provides set tracking, statistics, a calendar, SOS notes, and Community features.",
    ...
    "이메일 계정, 닉네임, 운동·세트 기록, SOS, 레벨·통계, 게시글·댓글·좋아요·신고·차단 관계 및 푸시 구독": "Email account, nickname, workout and set history, SOS entries, levels and statistics, posts, comments, likes, reports, blocks, and push subscriptions"
  };
